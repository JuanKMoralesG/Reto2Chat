package com.example.reto2chat.Presenter;
        ...
        if (user1 != null && user2 != null) {
            ...
            messagesRef.add(message)
                    ...
                    .addOnFailureListener(e -> {
                        Log.e(TAG, "Error enviando mensajes: " + e.getMessage());
            ...
            Log.e(TAG, "Usuario 1 o Usuario 2 esta vacio");
        }
    }
                    ...
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                        ...
                        if (userFromFirestore != null) {
                            if (userFromFirestore.getUserId() != null) {
                                ...
                                Log.e(TAG, "El Id de Usuario esta vacio: " + userFromFirestore.getEmail());
                            }
                        } else {
                            Log.e(TAG, "Usuario no encontrado en la colleción de usuarios");
                        }
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e(TAG, "Error tomando usuario de la colección de usuarios: " + e.getMessage());
                });
    }
